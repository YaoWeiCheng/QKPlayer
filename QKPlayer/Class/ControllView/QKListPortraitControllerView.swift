//
//  QKListPortraitControllerView.swift
//  QKPlayer
//
...
class QKListPortraitControllerView: UIView {
    ...
    override func layoutSubviews() {
        ...
        min_h = 20
        min_y = (self.bottomToolView.frame.height - min_h) / 2
        min_x = min_view_w - min_margin * 2 - min_w
...
extension QKListPortraitControllerView: QKSliderViewChangeStateDelegate {
